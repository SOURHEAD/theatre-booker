...
def after_login():
    ...
    x.geometry("1000x630")
    header=Label(x,text='Choose a movie',font=('Calibri',40,'bold'),bg='gray10',fg='SlateGray3')
    ...
    b1=Button(x, text='Black Panther',image=BlackPanther,compound='top',font=('Calibri',15),fg='mint cream',command=lambda: select_movie('Black Panther'),bg='gray10')
    b2=Button(x, text='Antman',image=Antman,compound='top',font=('Calibri',15),fg='mint cream',command=lambda: select_movie('Antman'),bg='gray10')
    b3=Button(x, text='IronMan',image=IronMan,compound='top',font=('Calibri',15),fg='mint cream',command=lambda: select_movie('IronMan'),bg='gray10')
    b4=Button(x, text='Doctor Strange',image=DoctorStrange,compound='top',font=('Calibri',15),fg='mint cream',command=lambda: select_movie('Doctor Strange'),bg='gray10')
    b5=Button(x, text='Avengers Endgame',image=AvengersEndgame,compound='top',font=('Calibri',15),fg='mint cream',command=lambda: select_movie('Avengers Endgame'),bg='gray10')
    b6=Button(x, text='Guardians Of The Galaxy',image=Gotg,compound='top',font=('Calibri',15),fg='mint cream',command=lambda: select_movie('Gotg'),bg='gray10')
