...
#yha par
#dekh 
#is 終わり() function ko change kario sirf
...
def  終わり():
    ...
    food='Food items:'
    for i in foodd.keys():
        food+=' '+str(foodd[i][1])+' '+foodd[i][0]+' '+i+','
